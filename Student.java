...
public class Student extends JFrame {
    ...
    private BinarySearchTree bst = new BinarySearchTree(); // BST instance
    ...
    public Student() {
        ...
        submit.addActionListener(e -> {
            ...
            String entryNumber1 = sentry.getText();
            String email = semail.getText();
            String contact = scontact.getText();
            String home = shome.getText();

            if (name.isEmpty() || entryNumber1.isEmpty() || email.isEmpty() || contact.isEmpty() || home.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Fill all the details :(");
            } else {
                StudentData student = new StudentData(name, entryNumber1, email, contact, home);
                bst.insert(student);
